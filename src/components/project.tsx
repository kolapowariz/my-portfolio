...
const projects = [
  {
    ...
    "technologies": ["Nextjs", "Shadcn UI", "Tailwind CSS", "TypeScript", "Supabase", "React Markdown"],
    "done": "Coming Soon"
  },
  {
    "title": "PodifyIt",
    ...
    "technologies": ["Nextjs", "Shadcn UI", "Tailwind CSS", "TypeScript", "Supabase", "pdfjs-dist"],
    "done": "Coming Soon"
  },
  {
    "title": "Healler",
